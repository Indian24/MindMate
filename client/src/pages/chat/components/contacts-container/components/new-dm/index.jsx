...
import { animatedDefaultOptions } from "@/lib/utils";
...
const NewDM = () => {
  ...
  return (
    ...
    <TooltipProvider>
    <Tooltip>
  <TooltipTrigger><FaPlus className="text-neutral-400 font-light text-opacity-90 text-start 
  hover:text-neutral-100 cursor-pointer transition-all duration-300" onClick={()=>setOpenNewContactModal(true)}/></TooltipTrigger>
...
<Dialog open={openNewContactModal} onOpenChange={setOpenNewContactModal}>
  <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col ">
    <DialogHeader>
      <DialogTitle>Please Select a Conatact</DialogTitle>
    ...
    </ScrollArea>)}
    {
        ...
        height={80}
        width={80}
        options={animatedDefaultOptions}
        />
